...
export const UI = {
  ...
  dateCreated: 'ڕێکەوتی تۆمارکردن',
  dateRange: 'مەودای ساڵ',
  allYears: 'هەموو ساڵەکان',
  reset: 'سڕینەوە',
  yearFrom: 'لە ساڵی',
  yearTo: 'تا ساڵی',
  dateStart: 'لە ڕێکەوتی',
  dateEnd: 'تا ڕێکەوتی',
  exactDates: 'یان ڕێکەوتی ورد هەڵبژێرە',
  dateInvalid: 'ڕێکەوتی دەستپێک دوای ڕێکەوتی کۆتاییە.',
  open: 'کردنەوە',
  untitled: 'بێ ناو',
  by: 'لەلایەن',
  page: 'پەڕە',
    ...
    image: kind === 'image'
      ...
      : kind === 'video'
        ...
        : kind === 'text'
          ...
          : null,
    videoSrc: kind === 'video'
      ? resolveMediaUrl(item.videoFileUrl || item.mediaUrl || item.fileUrl) || null
      : null,
    tags: tagsOf(item),
